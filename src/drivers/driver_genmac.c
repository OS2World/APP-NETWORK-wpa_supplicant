/*
 * WPA Supplicant - OS/2 Genmac driver interface
 *  Heavily based on the Windows/NDIS driver interface
...
/* include these here rather than include ntddndis.h */
...
#ifdef __GNUC__
/* compensate for alignment problem with gcc on OS/2 */
   ULONG Reserved;
#endif
